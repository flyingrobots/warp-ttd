...
|---|---|---|---|---|---|
| R-RMAP-1 | Roadmap artifacts are generated from GitHub issue state rather than maintained as independent truth. | `scripts/roadmap-dag.mjs`, `ROADMAP.md`, `docs/roadmap-dag.dot`, `docs/roadmap-dag.svg` | Current repository issues and native issue relationships. | Regeneration produces the committed roadmap Markdown, DOT, and SVG artifacts. | covered |
...
- GitHub Issues, milestones, labels, sub-issue relationships, and blocked-by edges for this repository.
