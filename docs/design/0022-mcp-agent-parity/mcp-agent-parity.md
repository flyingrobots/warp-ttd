...
```json
{
  ...
  "result": {
    ...
    "capabilityGrant": { "posture": "ABSENT", "reason": "Host adapter did not provide CapabilityGrant posture." },
    "capabilityPresentation": { "posture": "ABSENT", "reason": "Host adapter did not provide CapabilityPresentation posture." },
